...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, in.thedevguys.todo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, in.thedevguys.todo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
