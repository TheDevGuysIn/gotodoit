...
export const StatusDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="goToDoItApp.status.delete.question">Are you sure you want to delete this Status?</ModalBody>
      <ModalFooter>
