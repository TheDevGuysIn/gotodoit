...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_STATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATUS actions', async () => {
      const expectedActions = [
        {
