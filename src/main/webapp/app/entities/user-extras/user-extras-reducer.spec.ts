...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREXTRAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEREXTRAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEREXTRAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEREXTRAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEREXTRAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEREXTRAS actions', async () => {
      const expectedActions = [
        {
