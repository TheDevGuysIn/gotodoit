...
class TagResourceIT {
    ...
    void getAllTagsByColorIsEqualToSomething() throws Exception {
        ...
        // Get all the tagList where color equals to DEFAULT_COLOR
        defaultTagShouldBeFound("color.equals=" + DEFAULT_COLOR);

        // Get all the tagList where color equals to UPDATED_COLOR
        defaultTagShouldNotBeFound("color.equals=" + UPDATED_COLOR);
    }

    @Test
    @Transactional
    void getAllTagsByColorIsNotEqualToSomething() throws Exception {
        // Initialize the database
        tagRepository.saveAndFlush(tag);

        // Get all the tagList where color not equals to DEFAULT_COLOR
        defaultTagShouldNotBeFound("color.notEquals=" + DEFAULT_COLOR);

        // Get all the tagList where color not equals to UPDATED_COLOR
        defaultTagShouldBeFound("color.notEquals=" + UPDATED_COLOR);
    }
    ...
    void getAllTagsByColorIsInShouldWork() throws Exception {
        ...
        // Get all the tagList where color in DEFAULT_COLOR or UPDATED_COLOR
        defaultTagShouldBeFound("color.in=" + DEFAULT_COLOR + "," + UPDATED_COLOR);

        // Get all the tagList where color equals to UPDATED_COLOR
        defaultTagShouldNotBeFound("color.in=" + UPDATED_COLOR);
    }
    ...
    void getAllTagsByColorIsNullOrNotNull() throws Exception {
        ...
        defaultTagShouldBeFound("color.specified=true");

        // Get all the tagList where color is null
        defaultTagShouldNotBeFound("color.specified=false");
    }
    ...
    void getAllTagsByColorContainsSomething() throws Exception {
        ...
        // Get all the tagList where color contains DEFAULT_COLOR
        defaultTagShouldBeFound("color.contains=" + DEFAULT_COLOR);

        // Get all the tagList where color contains UPDATED_COLOR
        defaultTagShouldNotBeFound("color.contains=" + UPDATED_COLOR);
    }
    ...
    void getAllTagsByColorNotContainsSomething() throws Exception {
        ...
        // Get all the tagList where color does not contain DEFAULT_COLOR
        defaultTagShouldNotBeFound("color.doesNotContain=" + DEFAULT_COLOR);

        // Get all the tagList where color does not contain UPDATED_COLOR
        defaultTagShouldBeFound("color.doesNotContain=" + UPDATED_COLOR);
    }

    @Test
    @Transactional
    void getAllTagsByTaskIsEqualToSomething() throws Exception {
        // Initialize the database
        tagRepository.saveAndFlush(tag);
        Task task;
        ...
        // Get all the tagList where task equals to taskId
        defaultTagShouldBeFound("taskId.equals=" + taskId);

        // Get all the tagList where task equals to (taskId + 1)
        defaultTagShouldNotBeFound("taskId.equals=" + (taskId + 1));
    }
